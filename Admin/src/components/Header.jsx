import { Filter, Menu, Plus, Sun, Bell,Settings, ChevronDown } from "lucide-react";
...
function Header({sidebarCollapsed, onToggleSidebar}){
    ...
    <div className="flex-1 max-w-md mx-8">
        <div className="relative">
            ...
            dark:bg-slate-800 border border-slate-200 dark:border-slate-200
             dark:border-slate-700 rounded-xl text-slate -800 dark:text-white
              ...
              <button className="absolute right-2 top-1/2 transform -translate-y-1/2
               p-1.5 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300">
                <Filter />
              </button>
        </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <button className="hidden lg:flex items-center space-x-2 py-2 px-4 bg-gradient-to-r
             from-blue-500 to-purple-600 text-white rounded-xl hover:shadow-lg trnasition-a">
             ...
             <button className="relative p-2.5 rounded-xl text-slate-600 dark:text-slate-300
              ...
              <div className="flex items-center space-x-3 pl-3 border-l border-slate-200 dark:border-slate-700">
                <img src="https://images.pexels.com/photos/1681010/pexels-photo-1681010.jpeg? auto=compress&cs=tinysrgb&w=64&h=64&dpr=2"
                ...
                <div className="hidden md:block">
                    ...
                    <p className="text-us text-slate-500 dark:text-slate-400">Administrator</p>
                </div>
