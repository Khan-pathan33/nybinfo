...
const Wishlist = ({activePanel, handleClose}) => {
  return (
     <div className={`flex flex-col justify-between gap-5 bg-zinc-100 fixed top-0 right-0 bottom-0  z-40 left-auto w-[400px] border-1 border-zinc-300 py-7 transfrom transition-transfrom duration-300
     ${activePanel === 'wishlist' ? 'translate-x-0' : 'translate-x-full '}`}>
          ...
          {/* product detail */}
            ...
            {/* increment & decrement */}
              <div className='flex justify-between'>
                <span>$0.00</span>
                <button className='bg-blue-600 text-white text-sm px-5 py-[5px] rounded-full active:bg-blue-700'>Add to Cart</button> 
